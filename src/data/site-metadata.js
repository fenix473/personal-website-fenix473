...
export const projectsMeta = [
  {
    ...
    seo: {
      ...
      description: "Interactive 49-key digital piano built with React and Web Audio API. Features AI melody generation using Claude API, N8N workflow automation, and Neon database for saving compositions.",
      keywords: ["Web Audio API", "React Piano", "AI Music Generation", "Claude API", "N8N Automation", "Interactive Piano", "Digital Piano Web App"],
    },
